...
$(document).ready(function(){
      ...
      //  alert(celda.html());
        ...
        $(this).children("td").each(function (index2) 
        {
            ...
            if(index2==10)
            {
                ...
                if (campo10 == 'Pendiente')
                {
                    $('#contab').removeAttr('checked');
                }
                else
                {
                    $('#contab').attr('checked', 'checked');
                }
            }
        })
    });
    ...
    $('#btnGuardarRend').click(function(){
        ...
        if (verificar)
        {
            ...
            var data='accion=' + accion + '&codrend=' + codrend + '&contab=' + contab;
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                url:'../controller/contabilidadController.php', 
                data: data,
